				...
				<header id="page-header">
					...
					<ol class="breadcrumb">
						...
						<div class="pull-right">
							<a  class="btn btn-green" href="/position/register" ><i class="fa fa-plus"></i>New Position</a>
						</div>
					</ol>
				</header>
				<!-- /page title -->
...
<tbody>
								@foreach ($positions as $position)
									<tr>
										...
										<td>
											  	<a class="btn btn-sm btn-warning update-button" href="{{ route('showpos',$position->id) }}" ><i class="fa fa-pencil"></i> Edit</a>
										</td>
										<td>
