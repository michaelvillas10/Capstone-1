...
<section id="middle">
				...
				<header id="page-header">
					<h1>RELIGION TABLE</h1>
					<ol class="breadcrumb">
						<li><a href="#">Tables</a></li>
						<li class="active">Religion tables</li>
						<div class="pull-right">
							<button type="button" data-target=".bs-example-modal-full" class="btn btn-sm btn-green" data-toggle="modal"><i class="fa fa-plus"></i>New Religion</a>
						</div>
					</ol>
				</header>
				<!-- /page title -->
					...
					<div id="panel-1" class="panel panel-default">
						<div class="panel-heading">
							<span class="title elipsis">
								<strong>RELIGION</strong> <!-- panel title -->
							</span>
...
<tbody>
								@foreach ($religions as $religion)
									<tr>
										...
										<td>
											  <button type="submit" data-target=".bs-example-modal-update{{ $religion->id }}" class="btn btn-sm btn-warning update-button" data-toggle="modal" ><i class="fa fa-pencil"></i> Edit</a>
										</td>
										<td>
